...
<Image src="/blog/keywordext.png" width={800} height={400} alt="" />
...
We have used **Next.js 13** new **app directory** feature to organize our code. We have used **Next.js 13** new **server-side code** feature to make a request to an external API. We have used **Next.js 13** new **environment variables** feature to store our API key. We alos used **Tailwind CSS**.
