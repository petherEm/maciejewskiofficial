...
export const meta = {
  author: 'Piotr',
  date: '2024-02-03',
  title: 'NextAuth Credentials — easy signup & login with email & password (Next.js 14 App router and Zod resolver)',
  description:
...
<Image src="/blog/nextauth_1.webp" width={800} height={400} alt="" />
...
<Image src="/blog/nextauth_2.webp" width={800} height={400} alt="" />

2- You can then select Postgres Serverless SQL

<Image src="/blog/nextauth_3.webp" width={800} height={400} alt="" />

3 — add a name for your database and click **Create**

<Image src="/blog/nextauth_4.webp" width={800} height={400} alt="" />

4 — and then connect the newly created database to your project

<Image src="/blog/nextauth_5.webp" width={800} height={400} alt="" />
...
<Image src="/blog/nextauth_6.webp" width={800} height={400} alt="" />
...
<Image src="/blog/nextauth_7.webp" width={800} height={400} alt="" />

and, we should be able to see the inserted data in the console:

<Image src="/blog/nextauth_8.webp" width={800} height={400} alt="" />

## DATABASE PREPARATION

We need a users’ table in our database at this stage.

<Image src="/blog/nextauth_9.webp" width={800} height={400} alt="" />
...
<Image src="/blog/nextauth_10.webp" width={800} height={400} alt="" />
...
<Image src="/blog/nextauth_11.webp" width={800} height={400} alt="" />
