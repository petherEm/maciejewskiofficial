...
export default function Uses() {
  return (
    <>
      <Head>
        <title>Resume - Piotr Maciejewski</title>
        <meta name="description" content="projects, integrations, websites" />
      </Head>
      <SimpleLayout
        ...
        <div className="space-y-20">
          <ToolsSection title="Head of Sales & Integrations at Western Union" years="2021 - present">
            ...
            >
              ...
              Driving incremental revenue through WU cross-border payments
              product integrations to Financial Institution’s ecosystem (Tier 1
              - 2 banks & fintechs).
              <br />
              Ultimately responsible for the solution delivery, managing several
              cross-functional teams. Holistically responsible for sales,
              contract negotiations, business & compliance requirements capture,
              solution tailoring and Go-To-Market strategy.
            </Tool>
            <Tool
              title="Co-created 3-year omnichannel strategy for Germany and
              Switzerland."
            >
              Tasked with creating a new omnichannel strategy for Western Union
              in Germany and Switzerland to ensure the company’s long-term
          ...
          <ToolsSection title="Digital Product Manager - Strategic Partnerships at Western Union" years="2018 - 2021">
            <Tool title="Signed and executed contracts with 2 primary digital payment solutions in Germany, Poland and Switzerland">
              ...
              for the product development, managing several cross-functional
              teams, business & compliance requirements capture, solution
            ...
            <Tool title="Successful launch of 8 (countries) WU mobile applications, implementation of new ID verification method in Germany">
              ...
              launches (WU App) in Central Europe. - Managing key product
              metrics, and analytics and enhancing the customer experience
              within WU Core Digital Products.
            </Tool>
            <Tool title="All Key Accounts met the imposed financial targets">
              Executing the proper dynamic pricing and FX strategy on the
              covered markets. <br />
              Coordinating proper adoption of key Compliance requirements such
              as the 4th AML Directive and PSD2 to core products and partners’
          ...
          <ToolsSection title="Business Development Manager at Western Union" years="2014 - 2018">
            <Tool title="Signed 12 WU exclusive agent contracts in 4 years with major organisations across Central Europe, consistently delivering WU revenue targets and appropriate network quality.">
              ...
              (Banks, Post Offices and Global Retail Services, 20,000 POS) with
          ...
          <ToolsSection title="Compliance Officer, at Western Union" years="2012 - 2014">
            <Tool title="Developed and updated WU Central Eastern Europe Compliance policies and procedures. Onboarded 10+ WU agents in line with PSD2 and 4th AML Directive requirements. Built several analytics tools in Python & VBA ensuring the best data visualisation for Risk Control Teams.">
              ...
              oversight, audits and Due Diligence analysis. Actively
              participating in the reinforcement of the internal AML programme.
              Specialized in Fraud and Cyber Crimes acting as the major point of
          ...
          <ToolsSection title="Senior AML Analyst, at Royal Bank of Scotland (NatWest Group)" years="2008 - 2011">
            <Tool title="Leading the team of 4 people, responsible for extensive Due Diligence of corporate clients in France, Belgium and Luxembourg.">
              ...
              Group Anti-money laundering manual, updating procedures and
              policies as well as leading the training team for new hires.
            </Tool>
          </ToolsSection>
        </div>
      </SimpleLayout>
